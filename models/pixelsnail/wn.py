...
class WeightNormalization(tf.keras.layers.Wrapper):
    ...
    def __init__(self, layer: tf.keras.layers, data_init: bool = True, **kwargs: dict):
    ...
    def call(self, inputs: tf.Tensor) -> tf.Tensor:
        ...
        def _do_nothing() -> tf.Tensor:
            return tf.identity(self.g)

        def _update_weights() -> tf.Tensor:
    ...
    def _initialize_weights(self, inputs: tf.Tensor) -> List[Tensor]:
        """Initialize weight g.
    ...
    def _init_norm(self) -> List[tf.Tensor]:
    ...
    def _data_dep_init(self, inputs: tf.Tensor) -> List[tf.Tensor]:
    ...
    def remove(self) -> keras.layers.Layer:
        kernel = tf.Variable(
